...
public class Utils {
    ...
    public Utils(Chairs plugin) {
        this.plugin = plugin;
    }

    public boolean sitAllowed(Player player, Block block, boolean signCheck) {
    ...
    public Location getSitLocation(Block block, Float playerYaw) {
