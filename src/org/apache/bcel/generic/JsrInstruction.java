...
public abstract class JsrInstruction extends BranchInstruction implements
	...
	/**
	 * Returns an InstructionHandle to the physical successor of this
	 * JsrInstruction. <B>For this method to work, this JsrInstruction object
	 * must not be shared between multiple InstructionHandle objects!</B>
	 * Formally, there must not be InstructionHandle objects i, j where i != j
	 * and i.getInstruction() == this == j.getInstruction().
	 * 
